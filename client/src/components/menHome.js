...
export default class Home extends Component {
  ...
  retrievePosts() {
    axios.get("http://localhost:8000/men/posts").then(res => {
      if (res.data.success) {
        this.setState({
  ...
  onDelete = (id) => {
    ...
    axios.delete(`http://localhost:8000/men/post/delete/${id}`).then((res) => {
        ...
        <div className='row justify-content-between'>
          ...
          <div class="col-4">
              <div className=" text-end text-black mb-5">
                  <button className="btn btn-success"><a href="/dashboard/men/add" style={{ textDecoration: 'none', color: 'white' }}>Add New Item</a></button>
              </div>
          </div>
        ...
        <div className="col-lg-8 mx-auto my-lg-5">
            ...
            {this.state.posts.map((posts, index) => (
                <li className="list-group-item">
                    <div className="media align-items-lg-center flex-column flex-lg-row p-3">
                        <div className="media-body order-2 order-lg-1">
                            <h5 className="mt-0 font-weight-bold mb-2">
                                <a href={`/dashboard/men/post/${posts._id}`} style= {{ textDecoration: 'none' }}>
                                    {posts.topic}
                                </a>
                            </h5>
                    ...
                    <a className="btn btn-warning" href={`/dashboard/men/edit/${posts._id}`}>
